...
export const STATIC_SECURITY_HEADERS: ReadonlyArray<{
  ...
  {
    // Same-origin microphone powers the Hermès voice interface. Same-origin
    // geolocation powers the PV cockpit weather after the browser asks the user
    // for permission. Cross-origin frames remain denied; camera/topics stay off.
